...
_Context note: The_ &lt;**dataSource**> _element is used by the EDI repository’s provenance tracking system for linking between derived and source data packages. For more information, see additional data [repository resources from EDI.](https://edirepository.org/resources/provenance-metadata)_
...
![A flowchart for determining the structure and content of a methods element](images/9_Methods_flowchart.png "A flowchart to determine structure and content of an EML methods document")
