# 6. Data access and usage rights
...
_Context note: The EDI repository still recommends including the &lt;**access**> element as the first child of the root (**&lt;eml:eml>**) element and uses an [access control format](https://edirepository.org/resources/access-control) that conforms to the KNB system of using the LDAP “distinguishedName (dn)” for an individual, as in “uid=userID,o=EDI,dc=edirepository,dc=org.” Public access is recommended, but a [temporary embargo on the data entities](https://edirepository.org/about/edi-policy) may be requested with certain exceptions._
...
_Context note: Recommendations for handling [large datasets in EDI](https://ediorg.github.io/data-package-best-practices/large-data-sets.html). Contact [EDI support](mailto:support@edirepository.org)._
...
_Context note: The EDI repository will add a &lt;distribution> element at the dataset level that includes the dataset’s DOI which points to the dataset landing page within the repository._
...
The &lt;**licensed**> element was added in EML 2.2.0 and provides a structured approach for including common licenses. It is strongly recommended to choose community standard licenses for published dataset and describe them in &lt;**licensed**> using the &lt;**licenseName**>, &lt;**url**>, and &lt;**identifier**> elements as shown in Example 6.5. [Creative Commons](https://creativecommons.org) offers a number of well-established licenses that are commonly used and appropriate for research datasets.

The &lt;**intellectualRights**> element provides a free text field to explain data use policies. It is a TextType element (see Appendix 2) and thus can be formatted with &lt;**section**>, &lt;**para**> and other formatting elements. Use this element to clearly describe the policies and expectations for use of the dataset, particularly those not already stated in the dataset license. These policies and expectations should match those agreed upon by the dataset creators and affiliated institutions, funding agencies, and/or research networks. If data access at the repository or &lt;**access**> levels is different than any policy articulated here (e.g. restricted-access packages), explain why and provide expectations or a timeframe for data release.

_Context note: In-depth discussion of licensing data may be found at [EDI](https://edirepository.org/resources/licensing-data), the [LTER Network Data Access Policy](https://lternet.edu/data-access-policy/#:~:text=LTER%20data%20and%20metadata%20may,credited%20for%20the%20original%20creation.), and the respective recommended public licenses ([open access with attribution](https://spdx.org/licenses/CC-BY-4.0.html), [data in public domain](https://spdx.org/licenses/CC0-1.0.html))._

_Context note: If no &lt;intellectualRights> or &lt;licensed> element is included EDI will insert text that releases data under “CC-0”. The LTER Network-wide default policy is “CC-BY.” Please consult those organizations for more information and more details._
