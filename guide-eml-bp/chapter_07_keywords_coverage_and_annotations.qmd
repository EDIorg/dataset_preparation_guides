# 7. Keywords, coverage, and annotations
...
_Context note: Communities often have specific standards for keywords to assist in searches. For example, the LTER Network requests that datasets should include keywords for LTER core research areas (e.g. primary production), network and three-letter site acronyms (e.g. LTER, FLS), and relevant conceptual and subject-matter keywords from the [LTER Controlled Vocabulary](https://vocab.lternet.edu/vocab/vocab/index.php). Conventions vary by community though, so be aware of the best practices employed by your site, institution, data repository, or research community._
...
Example 7.10: An &lt;**annotation**> within the &lt;**additionalMetadata**> element used to provide parent organization information for a person (**@id=adam.sheperd**).
