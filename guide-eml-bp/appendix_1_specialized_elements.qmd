# Appendix 1. Specialized elements {.unnumbered}
...
Example A1.1: geographicCoverage under spatialSamplingUnits
...
Example A1.3: A methods element with some optional child elements &lt;sampling> and &lt;qualityControl>. Note the **sampling/spatialSamplingUnits/geographicCoverage** element.
...
Example A1.4: methods, with dataSource
      ...
      <description>
         <section>
            <para>We utilize NPP data collected from 1906 to 2006 from the ONL
               LTER site. The ONL NPP data unit definition is kg/m\^2/yr. This        unit does not require conversion.</para>
         </section>
      </description>
      <dataSource>
...
<url function="information">https://pasta.lternet.edu/package/metadata/eml/edi/15/5</url>
            </online>
         </distribution>
         <contact>
            <organizationName>ONL LTER</organizationName>
...
Example A1.5: Entity and attribute information for spatialVector
...
Example A1.6: Entity and attribute information for spatialRaster
...
Table A1.1 Summary of the six entities in EML, including the type of data entity typically described with that element, how they are created and a brief description of its metadata.
...
<table>
  <tr>
   ...
   <td><strong>Created from</strong>
   </td>
   <td><strong>Metadata features</strong>
   </td>
  </tr>
  <tr>
   <td>dataTable
   </td>
   <td>Static text data tables
   </td>
   <td>export from code, RDBMS or spreadsheets
   </td>
   <td>columns/rows named and defined, e.g., measurement and storage typing
   </td>
  </tr>
  <tr>
   <td>otherEntity
   </td>
   <td>Binary files, images, maps, pdf, code
   </td>
   <td>applications
   </td>
   <td>type of entity
  ...
  <tr>
   ...
   <td>grid, raster cell data, remote sensing data
   </td>
   <td>applications, stylesheet conversions. See "Other Resources"
   </td>
   <td>spatial organization of the raster cells, their data values, and if derived via imaging sensors, characteristics about the image and its individual bands
   </td>
  </tr>
  <tr>
   <td>spatialVector
   </td>
   <td>lines, points polygons, KML (if converted), Esri shape files
   </td>
   <td>applications, stylesheet conversions. See "Other Resources"
   </td>
   <td>information about the vector's geometry type, count, attributes, and topology level
   </td>
  </tr>
  <tr>
   <td>view
   </td>
   <td>Data returned from a database query
   </td>
   <td>RDBMS
   </td>
   <td>Recommended to handle as data table (above).
   </td>
  </tr>
  <tr>
   <td>storedProcedure
   </td>
   <td>Data returned from a stored procedure in a database
   </td>
   <td>RDBMS
   </td>
   <td>Recommended to handle as data table (above)
...
Table A1.2. Elements specific to each of the six entity types.
...
<table>
  ...
  <tr>
   ...
   <td>Static ASCII tables
   </td>
   <td>&lt;<strong>attributeList</strong>>
<p>
...
&lt;<strong>constraint</strong>>
<p>
&lt;<strong>queryStatement</strong>>
   </td>
  </tr>
  <tr>
   <td>&lt;<strong>storedProcedure</strong>>
   </td>
   <td>Data returned from a stored procedure in a database
   </td>
   <td>&lt;<strong>attributeList</strong>>
...
&lt;<strong>entityType</strong>>
  ...
  <tr>
   <td>&lt;<strong>spatialRaster</strong>>
   </td>
   <td>Lines, points polygons, KML (if converted), ESRI shape files
   </td>
   <td>&lt;<strong>attributeList</strong>>
...
&lt;<strong>constraint</strong>>
<p>
&lt;<strong>spatialReference</strong>>
<p>
&lt;<strong>georeferenceInfo</strong>>
<p>
&lt;<strong>horizontalAccuracy</strong>>
<p>
&lt;<strong>verticalAccuracy</strong>>
<p>
&lt;<strong>cellSizeYDirection</strong>>
<p>
&lt;<strong>numberOfBands</strong>>
<p>
&lt;<strong>rasterOrigin</strong>>
<p>
&lt;<strong>rows</strong>>
<p>
...
<p>
&lt;<strong>cellGeometry</strong>>
<p>
&lt;<strong>toneGradation</strong>>
<p>
&lt;<strong>scaleFactor</strong>>
<p>
...
&lt;<strong>imageDescription</strong>>
  ...
  <tr>
   <td>&lt;<strong>spatialVector</strong>>
   </td>
   <td>Lines, points polygons, KML (if converted), ESRI shape files
   </td>
   <td>&lt;<strong>attributeList</strong>>
...
<p>
&lt;<strong>geometricObjectCount</strong>>
<p>
&lt;<strong>topologyLevel</strong>>
<p>
&lt;<strong>spatialReference</strong>>
<p>
&lt;<strong>horizontalAccuracy</strong>>
